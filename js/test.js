...
TestBuilder = (function() {
  ...
  TestBuilder.prototype.ok = function() {
    return this.click("#hs-fancybox-ok");
  };
...
AnnouncementView = (function(_super) {
  ...
  AnnouncementView.prototype.initialize = function() {
    this.render();
    this.listenTo(this.collection, "change:selected", (function(_this) {
      return function() {
        return _this.render();
      };
    })(this));
    return this.listenTo(this.collection, "warning", (function(_this) {
      return function(arg) {
        return _this.showWarning(arg);
      };
    })(this));
  };

  AnnouncementView.prototype.template = function(ctx) {
    return "<div class='current-announcement'>\n    " + ctx.currentAnnouncement + "\n</div>\n<div class='warning'></div>";
  };

  AnnouncementView.prototype.render = function() {
    var currentAnnouncement;
    if (this.collection.selected == null) {
      return this;
    }
    if (this.collection.selected.announcement == null) {
      this.$el.empty();
      return this;
    }
    if (_.isFunction(this.collection.selected.announcement)) {
      currentAnnouncement = this.collection.selected.announcement();
    } else {
      currentAnnouncement = this.collection.selected.announcement;
    }
  ...
  AnnouncementView.prototype.showWarning = function(arg) {
    return this.$el.find(".warning").html(arg);
  };
...
},{"../models/passer.coffee":2}],20:[function(require,module,exports){
var CursorView,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
},{"../models/passer.coffee":2}],22:[function(require,module,exports){
...
},{"./announcement.coffee":18,"./controls.coffee":19,"./cursor.coffee":20,"./grade.coffee":21,"./progress.coffee":23,"./retries.coffee":24,"./url.coffee":25}],23:[function(require,module,exports){
...
},{"../collections/steps.coffee":1}],24:[function(require,module,exports){
...
},{"../models/passer.coffee":2}],25:[function(require,module,exports){
var URLView,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
